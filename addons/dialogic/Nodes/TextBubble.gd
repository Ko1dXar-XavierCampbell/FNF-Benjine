...
func load_theme(theme: ConfigFile):
	...
	text_container.set('offset_left', text_margin.x)
	text_container.set('offset_right', text_margin.x * -1)
	text_container.set('offset_top', text_margin.y)
	text_container.set('offset_bottom', text_margin.y * -1)
