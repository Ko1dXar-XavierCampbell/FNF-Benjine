...
func _ready() -> void:
	...
	n['box_margin_v'].connect('value_changed', Callable(self, '_on_generic_value_change').bind('box', 'box_margin_v'))
	n['box_margin_h'].connect('value_changed', Callable(self, '_on_generic_value_change').bind('box', 'box_margin_h'))
	...
	# Character Picker
	n['character_picker'].connect('about_to_popup', Callable(self, 'character_picker_about_to_show'))
	n['character_picker'].get_popup().connect('index_pressed', Callable(self, 'character_picker_selected'))
